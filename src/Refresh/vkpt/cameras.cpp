...
static const cmdreg_t cmds[] = { { "camera", &Camera_Cmd_f, NULL }, { NULL, NULL, NULL } };

void vkpt_cameras_init(void) { Cmd_Register(cmds); }

void vkpt_cameras_shutdown(void) { Cmd_RemoveCommand("camera"); }
