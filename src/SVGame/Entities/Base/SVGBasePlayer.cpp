...
**/
SVGBaseItemWeapon* SVGBasePlayer::ChangeWeapon(int32_t weaponID, qboolean storeLastWeapon) {
    ...
    //SVGBaseItemWeapon::InstanceWeaponThink(this, weaponInstance, GetClient());
