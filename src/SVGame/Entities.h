...
**/
template<std::size_t start, std::size_t count> inline auto GetEntityRange() -> std::span<Entity, count> { return std::span(g_entities).subspan<start, count>(); }
...
*           that passed the filter process.
**/
template<std::size_t start, std::size_t count> inline auto GetBaseEntityRange() -> std::span<SVGBaseEntity*, count> { return std::span(g_baseEntities).subspan<start, count>(); }
...
*           that passed the filter process.
**/
inline EntitySpan GetEntityRange(std::size_t start, std::size_t count) { return EntitySpan(g_entities).subspan(start, count); }
...
*           that passed the filter process.
**/
inline BaseEntitySpan GetBaseEntityRange(std::size_t start, std::size_t count) { return BaseEntitySpan(g_baseEntities).subspan(start, count); }
