...
Fires a single nail.  Used by the Perforator/Nailgun.
=================
*/
...
void fire_nail(edict_t* self, vec3_t start, vec3_t dir, int damage, int speed, int effect, qboolean hyper, int color)
{
	edict_t* nail;
	trace_t	tr;
...
// SP_nail should ONLY be used for nails that have
// changed maps via trigger_transition. It should NOT be used for map
// entities. 
void nail_delayed_start(edict_t* nail)
{
	if (g_edicts[1].linkcount)
	{
