...
*/
	{
		...
		Weapon_Shotgun,
		"misc/w_pkup.wav",
		"models/weapons/g_shotg/g_shotg.md2", 0, EF_ROTATE,
		"models/weapons/v_shotg/v_shotg.md2",
/* icon */		"w_shotgun",
/* pickup */	"Shotgun",
		0,
		1,
...
*/
	{
		...
		Weapon_SuperShotgun,
		"misc/w_pkup.wav",
		"models/weapons/g_shotg2/g_shotg2.md2", 0, EF_ROTATE,
		"models/weapons/v_shotg2/v_shotg2.md2",
/* icon */		"w_sshotgun",
...
*/
	{
		...
		Weapon_GrenadeLauncher,
		"misc/w_pkup.wav",
		"models/weapons/g_launch/g_launch.md2", 0, EF_ROTATE,
		"models/weapons/v_launch/v_launch.md2",
/* icon */		"w_glauncher",
...
*/
	{
		...
		Weapon_RocketLauncher,
		"misc/w_pkup.wav",
		"models/weapons/g_rocket/g_rocket.md2", 0, EF_ROTATE,
		"models/weapons/v_rocket/v_rocket.md2",
/* icon */		"w_rlauncher",
...
*/
	{
		...
		Weapon_HyperBlaster,
		"misc/w_pkup.wav",
		"models/weapons/g_perf/g_perf.md2", 0, EF_ROTATE,
		"models/weapons/v_perf/v_perf.md2",
/* icon */		"w_hyperblaster",
/* pickup */	"HyperBlaster",
		0,
		1,
...
void SetItemNames (void)
{
	...
	gi.configstring(CS_ITEMS + ITEM_INDEX(FindItem("HyperBlaster")), "Perforator");
}
