...
static void PM_StepDown(const trace_t* trace) {
    ...
    playerMoveLocals.origin = trace->endPosition;
...
static bool PM_SlideMove(void)
{
    ...
    for (int bumpCount = 0; bumpCount < numBumps; bumpCount++) {
        ...
        //if (trace.fraction > 0) {
        //    // actually covered some distance
        //    VectorCopy(trace.endPosition, playerMoveLocals.origin);
        //    numPlanes = 0;
        //}
...
static void PM_Friction(void)
{
    ...
    if ((pm->groundEntityPtr && playerMoveLocals.ground.surface && !(playerMoveLocals.ground.surface->flags & SURF_SLICK)) || (playerMoveLocals.ladder)) {
