...
public:
    ...
    // Callback functions.
    void TriggerAlwaysTouch(IServerGameEntity* self, IServerGameEntity* other, CollisionPlane* plane, CollisionSurface* surf);
    void TriggerAlwaysUse(IServerGameEntity* other, IServerGameEntity* activator);
