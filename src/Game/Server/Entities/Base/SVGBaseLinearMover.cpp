...
*	@file
*
*	ServerGame Linear base mover entity.
* 
***/
//! Main Headers.
...
**/
void SVGBaseLinearMover::SpawnKey( const std::string& key, const std::string& value ) {
	// Accel.
	if ( key == "accel" ) {
		// Parse float.
...
//===============
void SVGBaseLinearMover::BrushAngleMoveDone() {
	SetAngularVelocity( vec3_zero() );
	moveInfo.OnEndFunction( this );
}

//===============
// SVGBaseLinearMover::BrushAngleMoveFinal
//===============
void SVGBaseLinearMover::BrushAngleMoveFinal() {
	vec3_t move;
	...
	SetThinkCallback( &SVGBaseLinearMover::BrushAngleMoveDone );
	SetNextThinkTime( level.time + FRAMETIME_S );
}

//===============
// SVGBaseLinearMover::BrushAngleMoveBegin
//===============
void SVGBaseLinearMover::BrushAngleMoveBegin() {
	...
	SetThinkCallback( &SVGBaseLinearMover::BrushAngleMoveFinal );
	SetNextThinkTime( level.time + frames * FRAMETIME_S );
}

//===============
// SVGBaseLinearMover::BrushAngleMoveCalc
//===============
void SVGBaseLinearMover::BrushAngleMoveCalc( LinearPushMoveEndFunction* function ) {
	SetAngularVelocity( vec3_zero() );
	...
	if ( level.currentEntity == ((GetFlags() & EntityFlags::TeamSlave) ? GetTeamMasterEntity() : this) ) {
		...
		SetThinkCallback( &SVGBaseLinearMover::BrushAngleMoveBegin );
		SetNextThinkTime( level.time + FRAMERATE_MS );
	}
}

//===============
// SVGBaseLinearMover::BrushAccelerateCalc
//===============
void SVGBaseLinearMover::BrushAccelerateCalc() {
...
//===============
// SVGBaseLinearMover::BrushAccelerate
//===============
void SVGBaseLinearMover::BrushAccelerate() {
	// Are we decelerating?
...
//===============
// SVGBaseLinearMover::BrushAccelerateThink
// 
// The team has completed a frame of movement,
// so change the speed for the next frame
//===============
void SVGBaseLinearMover::BrushAccelerateThink() {
...
//===============
// SVGBaseLinearMover::CalculateAccelerationDistance
//===============
float SVGBaseLinearMover::CalculateAccelerationDistance( float targetSpeed, float accelerationRate ) {
