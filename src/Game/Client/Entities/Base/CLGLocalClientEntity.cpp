...
void CLGLocalClientEntity::ProcessSkeletalAnimationForTime(uint64_t time) {
...
**/
void CLGLocalClientEntity::PrepareRefreshEntity(const int32_t refreshEntityID, EntityState *currentState, EntityState *previousState, float lerpFraction) {
