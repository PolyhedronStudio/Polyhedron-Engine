...
public:
    ...
    **/
	...
	virtual SGEntityHandle  GetGroundEntity() override { return groundEntity; }; //SGEntityHandle(); };
    virtual void            SetGroundEntity(GameEntity* groundEntity) override { this->groundEntity = groundEntity; };
