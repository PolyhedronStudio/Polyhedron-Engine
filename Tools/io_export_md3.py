  ...
  for obj in selobjects:
    if obj.type == 'MESH':
      ...
      try:
        ...
        shaders = obj.data["md3shader"]
        shaders = shaders.split(';')
        
        for s,n in enumerate(shaders):
          nshader = md3Shader()
          nshader.name = n#Set Property Value to shader path/filename
        ...
        if obj.active_material:      
          ...
          nshader.name = "NULL"      
        nsurface.shaders.append(nshader)
      nsurface.numShaders = len(nsurface.shaders) 
