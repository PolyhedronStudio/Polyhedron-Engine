...
*           are never finished.
**/
float SG_FrameForTime(int32_t* frame, int32_t curTime, int32_t startTimeStamp, float frametime, int32_t firstFrame, int32_t lastframe, int32_t loopingFrames = 0, bool forceLoop = true);