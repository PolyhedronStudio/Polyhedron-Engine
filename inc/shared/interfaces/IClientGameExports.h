...
//using ConsoleCommandFunction = void(*)();
//class ICommandSystem
//{
//public:
//    virtual void RegisterMacro(const char* name, ConsoleCommandFunction function) = 0;
//}
...
//public:
//    ICommon* Common;
//    ICommandSystem* Command;

//    void SomeClientSpecificFunction() = 0;
//};
...
//---------------------------------------------------------------------
class IClientGameExportCollisionModel {
...
// COMMAND interface.
//---------------------------------------------------------------------
class IClientGameExportCommand {
...
class IClientGameExportCommon {
	...
	const char* ErrorString) (qerror_t type) = 0;
	// Returns the event time between "common event frames" engine internal.
	unsigned GetEventTime(void) = 0;
};

//---------------------------------------------------------------------
// CONSOLE interface.
//---------------------------------------------------------------------
class IClientGameExportConsole {
