...
void InitLithiumVars (void)
{
	...
	sk_shotgun_damage = gi.cvar("sk_shotgun_damage", "1.75", 0);
	...
	sk_sshotgun_hspread = gi.cvar("sk_sshotgun_hspread", "900", 0);
	sk_sshotgun_vspread = gi.cvar("sk_sshotgun_vspread", "900", 0);
	...
	sk_grenade_radius = gi.cvar("sk_grenade_radius", "165", 0);
	...
	sk_rocket_speed = gi.cvar("sk_rocket_speed", "750", 0);
